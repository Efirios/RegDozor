...
/**
 * "Сопоставитель кодов": чистая функция без ввода-вывода — дан текст и список кодов,
 * возвращает те коды, что встречаются в тексте (простой contains). Не знает и не должен знать,
