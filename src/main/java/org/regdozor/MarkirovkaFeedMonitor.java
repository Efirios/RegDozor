...
public class MarkirovkaFeedMonitor {
     ...
     * ⚠️ ХОЛОДНЫЙ СТАРТ (пустой seen) пока не приручён: все 16 статей раздела окажутся «новыми» и
     *    полетят как алерты, хотя это старьё. Отдельный шаг «на чистой установке заполнить seen молча».
     */
    public void run(){
