...
/**
 * Ответственность за нарушение конкретной обязанности (живёт ВНУТРИ Obligation, а не Product —
 * у разных обязанностей разные статьи КоАП). Может быть null, если норма ещё не проверена.
 *
